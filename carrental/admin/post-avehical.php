...
$sql="INSERT INTO tblmatch(TeamName,OppositionName,MatchDate) VALUES(:teamname,:brandname,:matchdate)";
$query = $dbh->prepare($sql);
$query->bindParam(':teamname',$TeamName,PDO::PARAM_STR);
$query->bindParam(':brandname',$brand,PDO::PARAM_STR);
$query->bindParam(':matchdate',$MatchDate,PDO::PARAM_STR);
$query->execute();
$lastInsertId = $dbh->lastInsertId();
if($lastInsertId)
{
$msg="Match Posted Successfully";
}
else 
{
...
<head>
	...
	<title>Cricket Portal | Admin Post Match</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Post A Match</h2>
...
<label class="col-sm-2 control-label">Select Opposition<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Match Date<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="matchdate" class="form-control" required>
</div>
</div>

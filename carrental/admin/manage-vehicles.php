...
<head>
	...
	<title>Cricket Portal |Admin Manage Match   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Manage Match</h2>
...
<?php $sql = "SELECT TeamName,OppositionName,MatchDate from tblmatch";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->OppositionName);?></td>
											<td><?php echo htmlentities($result->MatchDate);?></td>
